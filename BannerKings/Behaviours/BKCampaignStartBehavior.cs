    ...
    public class BKCampaignStartBehavior : CampaignBehaviorBase
    {
        ...
        private void ShowInquiry()
        {
            ...
            var titleDutiesRights = new LearningElement(new TextObject("{=gDZdEBaiL}Titles - Duties & Rights"),
                ...
                new TextObject("{=SQJsSOf5f}Learn about the duties and rights between vassals and suzerains."));
