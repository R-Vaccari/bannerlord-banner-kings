    ...
    public class BKCampaignStartBehavior : CampaignBehaviorBase
    {
        ...
        private void ShowInquiry()
        {
            ...
            var titleDutiesRights = new LearningElement(new TextObject("{=3g7ru6NfE}Titles - Duties & Rights"),
                ...
                new TextObject("{=3g7ru6NfE}Learn about the duties and rights between vassals and suzerains."));
