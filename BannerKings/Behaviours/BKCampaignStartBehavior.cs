    ...
    public class BKCampaignStartBehavior : CampaignBehaviorBase
    {
        ...
        private void ShowInquiry()
        {
            ...
            var titleDutiesRights = new LearningElement(new TextObject("{=XGJwauOX}Titles - Duties & Rights"),
                ...
                new TextObject("{=OFTeGdTB}Learn about the duties and rights between vassals and suzerains."));
