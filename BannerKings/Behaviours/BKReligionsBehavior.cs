    ...
    public class BKReligionsBehavior : CampaignBehaviorBase
    {
        ...
        private void AddDialogue(CampaignGameStarter starter)
        {
            ...
            starter.AddDialogLine("bk_answer_boon", "bk_preacher_asked_boon", "bk_preacher_asked_boon_answer",
                "{=sg9jzuEuv}{CLERGYMAN_BLESSING_QUESTION}",
            ...
            starter.AddDialogLine("bk_boon_confirm", "bk_boon_confirm", "bk_boon_confirm",
                "{=53231SPkV}{CLERGYMAN_BLESSING_CONFIRM}",
                null, null);

            starter.AddPlayerLine("bk_boon_confirm", "bk_boon_confirm", "hero_main_options", "{=P1XwVP0Mu}See it done.",
            ...
            starter.AddPlayerLine("bk_question_rite", "hero_main_options", "bk_preacher_asked_rites",
                "{=zhgMs1TfE}I would like to perform a rite.",
                IsPreacher,
                RitesOnConsequence,
                100,
                RitesOnClickable);
            ...
            starter.AddDialogLine("bk_answer_rite_impossible", "bk_preacher_asked_rites", "hero_main_options",
                "{=FhQmUn2gY}I am afraid that won't be possible.",
                IsPreacher,
                null);
            ...
            starter.AddDialogLine("bk_rite_confirm", "bk_rite_confirm", "bk_rite_confirm",
                "{=j5K75g5DK}{CLERGYMAN_RITE_CONFIRM}",
                null, null);
            starter.AddPlayerLine("bk_rite_confirm", "bk_rite_confirm", "hero_main_options", "{=P1XwVP0Mu}See it done.",
                null, () =>
                {
        ...
        private bool InductionOnClickable(out TextObject hintText)
        {
            ...
            {
                hintText = new TextObject("{=tQj3WKQoD}Already an adherent of this faith.");
                return false;
            }
            ...
            hintText = new TextObject(
                    "{=XHnoUob05}{POSSIBLE}. Changing faiths will significantly impact your clan's renown. Your piety in the new faith will be zero. Lords of {CURRENT_FAITH} faith may disapprove your change.")
        ...
        private void BlessingPositiveAnswerOnConsequence()
        {
            ...
            var list = religion.Faith.GetSecondaryDivinities()
                .Select(div => new InquiryElement(div, div.Name.ToString(), null, piety >= div.BlessingCost, new TextObject("{=ajoCTjXcg}{DESCRIPTION}\n{EFFECTS}").SetTextVariable("DESCRIPTION", div.Description)
            ...
            MBInformationManager.ShowMultiSelectionInquiry(new MultiSelectionInquiryData(
                ...
                new TextObject("{=X3JCRntAj}Select which of the {SECONDARIES} you would like to {BLESSING_ACTION}.")
        ...
        private bool BlessingOnClickable(out TextObject hintText)
        {
            ...
            {
                hintText = new TextObject("{=r1g4pPHas}You do not adhere to the {FAITH} faith.")
            ...
            if (!anyPossible)
            {
                hintText = new TextObject("{=PD4sW3mKr}Not enough piety to receive any blessing (minimum {PIETY} piety).")
                    .SetTextVariable("PIETY", minPiety);
                return false;
            }

            hintText = new TextObject("{=REU75n2dQ}Expend your piety in exchange of a blessing or inspiration.");
            return true;
        }
        ...
        private bool RitesOnClickable(out TextObject hintText)
        {
            ...
            if (!anyPossible)
            {
                hintText = new TextObject("{=VzeW2X9rH}No rite is currently possible to perform.");
                return false;
            }

            hintText = new TextObject("{=g4ULt9SLe}Perform a rite such as an offering in exchange for piety.");
            return true;
        }
        ...
        private void RitesOnConsequence()
        {
            ...
            var faithText = new TextObject("{=d7w47A7Ob}{FAITH} teaches us that we may perform {RITES}.");
            var riteText =
                new TextObject(
                        "{=Vepgun99o}Certainly, {HERO}. Remember that proving your devotion is a life-long process. Once a rite is done, some time is needed before it may be consummated again. {RITES}")
