    ...
    public class BKSettlementBehavior : CampaignBehaviorBase
    {
        ...
        private void OnSiegeAftermath(MobileParty attackerParty, Settlement settlement, SiegeAftermathCampaignBehavior.SiegeAftermath aftermathType, Clan previousSettlementOwner, Dictionary<MobileParty, float> partyContributions)
        {
            ...
            InformationManager.DisplayMessage(new InformationMessage(
                new TextObject("{=pnZKnBhzS}{NUMBER} people have been killed in the siege aftermath of {SETTLEMENT}.")
        ...
        private void OnSessionLaunched(CampaignGameStarter campaignGameStarter)
        {
            ...
            if (retinueType == null)
            {
                Utils.Helpers._buildingCastleRetinue.Initialize(new TextObject("{=rLt9Mk0e6}Retinue Barracks"),
                    new TextObject("{=NNAZQubOG}Barracks for the castle retinue, a group of elite soldiers. The retinue is added to the garrison over time, up to a limit of 20, 40 or 60 (building level)."),
                    new[]
                    {
                        1000,
                        1500,
