<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="Culture[@id='republic']/clan_names">
        <clan_names>
		  <name name="Acapanos" />
		  <name name="Angarys" />
		  <name name="Balastisos" />
	...
	<xsl:template match="Culture[@id='nordling']/clan_names">
        <clan_names>
		  <name name="Asraloving" />
		  <name name="Boranoving" />
		  <name name="Folyoroving" />
	...
	<xsl:template match="Culture[@id='rhodok']/clan_names">
        <clan_names>
		  <name name="dey Sunor" />
		  <name name="dey Haringoth" />
		  <name name="dey Kelredan" />
	...
	<xsl:template match="Culture[@id='vagir']/clan_names">
        <clan_names>
		  <name name="fen Gwynn" />
		  <name name="fen Wiarannus" />
		  <name name="fen Gechal" />
	...
	<xsl:template match="Culture[@id='rebkhu']/clan_names">
        <clan_names>
		  <name name="Airit" />
		  <name name="Aldusunit" />
		  <name name="Bochit" />
