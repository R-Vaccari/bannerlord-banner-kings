            ...
            if (council.Owner == Hero.MainHero)
            {
                foreach (var vm in AvailableGovernors)
                {
                    ...
                    if (vm.Governor != null)
                    {
                        ...
                        sb.AppendLine(new TextObject("{=OeCwYqwvL}Competence:").ToString() +
                ...
                MBInformationManager.ShowMultiSelectionInquiry(
                    new MultiSelectionInquiryData(
                        new TextObject("{=vKHkyKSLF}Select Councillor").ToString(),
                        new TextObject("{=oRZeSFGs5}Select who you would like to fill this position.").ToString(),
