            ...
            if (council.Owner == Hero.MainHero)
            {
                foreach (var vm in AvailableGovernors)
                {
                    ...
                    if (vm.Governor != null)
                    {
                        ...
                        sb.AppendLine(new TextObject("{=Dmc7fm5zD}Competence:").ToString() +
                ...
                MBInformationManager.ShowMultiSelectionInquiry(
                    new MultiSelectionInquiryData(
                        new TextObject("{=93PM2wmpM}Select Councillor").ToString(),
                        new TextObject("{=wwOsNdKBh}Select who you would like to fill this position.").ToString(),
