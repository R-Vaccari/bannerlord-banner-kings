...
namespace BannerKings.UI.CampaignStart
{
    public class StartOptionVM : BannerKingsViewModel
    {
        ...
        private List<TooltipProperty> GetHint()
        {
            ...
            list.Add(new TooltipProperty(new TextObject("{=EU1VetgfW}Stats").ToString(), " ", 0));
            ...
            list.Add(new TooltipProperty(new TextObject("{=vQareqT24}Criminal").ToString(), Criminal, 0));
