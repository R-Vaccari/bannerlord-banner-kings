...
namespace BannerKings.UI.Management
{
    public class EconomyVM : BannerKingsViewModel
    {
        ...
        public HintViewModel TournamentHint => new(new TextObject(
            "{=LxF9shedM}Sponsor a tournament in this town. As the main sponsor, you have to pay 5000 coins for the tournament costs, as well as " +
        ...
        public override void RefreshValues()
        {
            ...
            ProductionInfo.Add(new InformationElement(new TextObject("Production Efficiency:").ToString(),
                ...
                new TextObject("{=rfv1XG7tT}{TEXT}\n{EXPLANATIONS}")
                    .SetTextVariable("TEXT",
                        new TextObject(
                            "{=DEv5FAcVG}The speed at which workshops produce goods, affected by kingdom policies and craftsmen"))
            ...
            else
            {
                ...
                RevenueInfo.Add(new InformationElement(new TextObject("Mercantilism:").ToString(),
                    ...
                    new TextObject("{=rfv1XG7tT}{TEXT}\n{EXPLANATIONS}")
                        .SetTextVariable("TEXT",
                            new TextObject(
                                "{=orgLyh96N}Represents how economicaly free craftsmen, tradesmen and guilds are. Increased mercantilism reduces the tax revenue of these, but allows them to accumulate wealth or contribute more to overall prosperity."))
                ...
                RevenueInfo.Add(new InformationElement(new TextObject("Caravan Attractiveness:").ToString(),
                    ...
                    new TextObject("{=rfv1XG7tT}{TEXT}\n{EXPLANATIONS}")
                        .SetTextVariable("TEXT",
                            new TextObject(
                                "{=35hdo7N8x}How attractive this town is for caravans. Likelihood of caravan visits are dictated mainly by prices, and attractiveness is a factor added on top of that."))
