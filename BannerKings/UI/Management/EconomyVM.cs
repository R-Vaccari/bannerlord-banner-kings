        ...
        public override void RefreshValues()
        {
            ...
            else
            {
                ...
                RevenueInfo.Add(new InformationElement(new TextObject("{=Re0UyaL5}Tariff:").ToString(),
                    ...
                    new TextObject("{=!}Tariffs determine the percentage of sale revenues that are owned to the fief's lord. This applies both to trade between the fief and free parties, as well as the fief and its population. Thus, the more goods the population consumes, the more tariffs they yield.").ToString()));
