            ...
            if (title != null)
            {
                ...
                GovernmentInfo.Add(new InformationElement(new TextObject("Demesne limit:").ToString(),
                    ...
                    new TextObject("{TEXT}\nCurrent demesne:\n{CURRENT}\n \nLimit:\n{LIMIT}")
                        .SetTextVariable("TEXT",
                            new TextObject(
                                "{=0h04mrpb}Demesne limit describes how many settlements you may own without negative implications. Different settlement types have different weights, villages being the lowest, towns being the highest. Being over the limit reduces stability across all your settlements. Owning a settlement's title will reduce it's weight."))
                ...
                GovernmentInfo.Add(new InformationElement(new TextObject("Unlanded Demesne limit:").ToString(),
                    ...
                    new TextObject("{TEXT}\nCurrent demesne:\n{CURRENT}\n \nLimit:\n{LIMIT}")
                        .SetTextVariable("TEXT",
                            new TextObject(
                                "{=jP3f1RBn}Unlanded demesne limit describes how many unlanded titles you may own. Unlanded titles are titles such as dukedoms and kingdoms - titles not directly associated with a settlement. Dukedoms have the lowest weight while empires have the biggest. Being over the limit progressively reduces relations with your vassals."))
