        ...
        public override void RefreshValues()
        {
            ...
            if (title != null)
            {
                ...
                if (legitimacyType > 0f)
                {
                    ...
                    DemesneInfo.Add(new InformationElement(new TextObject("Legitimacy:").ToString(),
                ...
                {
                    DemesneInfo.Add(new InformationElement(new TextObject("Sovereign:").ToString(),
                        title.sovereign.FullName.ToString(),
                        new TextObject("The master suzerain of this title, be they a king or emperor type suzerain.")
                            .ToString()));
                }

                if (duchy != null)
                {
                    DemesneInfo.Add(new InformationElement("Dukedom:", duchy.FullName.ToString(),
                ...
                GovernmentInfo.Add(new InformationElement(new TextObject("Demesne limit:").ToString(),
                    currentDemesne.ResultNumber + " / " + demesneCap.ResultNumber,
                    new TextObject("{TEXT}\nCurrent demesne:\n{CURRENT}\n \nLimit:\n{LIMIT}")
                        .SetTextVariable("TEXT",
                            new TextObject(
                                "{=AN0141TQ6}Demesne limit describes how many settlements you may own without negative implications. Different settlement types have different weights, villages being the lowest, towns being the highest. Being over the limit reduces stability across all your settlements. Owning a settlement's title will reduce it's weight."))
                        .SetTextVariable("CURRENT", currentDemesne.GetExplanations())
                        .SetTextVariable("LIMIT", demesneCap.GetExplanations())
                        .ToString()));

                var currentUnlandedDemesne =
                    BannerKingsConfig.Instance.StabilityModel.CalculateCurrentUnlandedDemesne(Hero.MainHero.Clan);
                var unlandedDemesneCap =
                    BannerKingsConfig.Instance.StabilityModel.CalculateUnlandedDemesneLimit(Hero.MainHero);

                GovernmentInfo.Add(new InformationElement(new TextObject("Unlanded Demesne limit:").ToString(),
                    currentUnlandedDemesne.ResultNumber + " / " + unlandedDemesneCap.ResultNumber,
                    new TextObject("{TEXT}\nCurrent demesne:\n{CURRENT}\n \nLimit:\n{LIMIT}")
                        .SetTextVariable("TEXT",
                            new TextObject(
                                "{=URGCMmxAs}Unlanded demesne limit describes how many unlanded titles you may own. Unlanded titles are titles such as dukedoms and kingdoms - titles not directly associated with a settlement. Dukedoms have the lowest weight while empires have the biggest. Being over the limit progressively reduces relations with your vassals."))
                ...
                GovernmentInfo.Add(new InformationElement(new TextObject("Succession Type:").ToString(),
                    title.contract.Succession.ToString().Replace("_", " "),
                    new TextObject(
                            "The clan succession form associated with this title. Successions only apply to factions.")
                        .ToString()));
                GovernmentInfo.Add(new InformationElement(new TextObject("Inheritance Type:").ToString(),
                    title.contract.Inheritance.ToString(),
                    new TextObject(
                            "The inheritance form associated with this settlement's title. Inheritance dictates who leads the clan after the leader's death.")
                        .ToString()));
                GovernmentInfo.Add(new InformationElement(new TextObject("Gender Law:").ToString(),
                    title.contract.GenderLaw.ToString(),
                    new TextObject(
                            "The gender law associated with this settlement's title. Gender law affects how inheritance and other aspects of rule work.")
                        .ToString()));
            ...
            LandInfo.Add(new InformationElement(new TextObject("Farmland:").ToString(), landData.Farmland + " acres",
                new TextObject("Acres in this region used as farmland, the main source of food in most places")
                    .ToString()));
            ...
            TerrainInfo.Add(new InformationElement(new TextObject("Fertility:").ToString(), FormatValue(landData.Fertility),
                new TextObject(
                    ...
                    .ToString()));
            TerrainInfo.Add(new InformationElement(new TextObject("Terrain Difficulty:").ToString(),
            ...
            WorkforceInfo.Add(new InformationElement(new TextObject("Available Workforce:").ToString(),
            ...
            WorkforceInfo.Add(new InformationElement(new TextObject("Workforce Saturation:").ToString(),
            ...
            {
                workforceItem =
                    (BKWorkforcePolicy) BannerKingsConfig.Instance.PolicyManager.GetPolicy(data.Settlement, "workforce");
