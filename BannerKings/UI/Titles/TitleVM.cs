    ...
    public class TitleVM : ViewModel
    {
        ...
        public override void RefreshValues()
        {
            ...
            if (title != null)
            {
                ...
                {
                    var usurpButton = new DecisionElement().SetAsButtonOption(new TextObject("{=MBA6Qgfd0}Usurp").ToString(),
                ...
                {
                    var claimButton = new DecisionElement().SetAsButtonOption(new TextObject("{=Z6LvYPQFu}Claim").ToString(),
                ...
                {
                    var grantButton = new DecisionElement().SetAsButtonOption(new TextObject("{=2j4WYmZe7}Grant").ToString(),
                ...
                {
                    var revokeButton = new DecisionElement().SetAsButtonOption(new TextObject("{=b1gJcNSsx}Revoke").ToString(),
