...
namespace BannerKings.Managers.Titles.Governments
{
    public class DefaultGovernments : DefaultTypeInitializer<DefaultGovernments, Government>
    {
        ...
        {
            Republic.Initialize(new TextObject("{=omjWITjC}Republic"),
                new TextObject("{=6ha7q3o5}Republics are a Calradoi government with the purpose of preventing authoritarian regimes of power. Before the Calradoi organized themselves into the empire, they were a republic, government by a body of peers called the Senate. They were traditionally quite resistant to any attempts of power concentration at the hands of one or another senator, lest they turn into a monarchical regime... Yet, at times of war, strong, unquestioned leadership was needed, wich could be granted to a temporary senator holding all the power - the Diktator. History teaches that one Diktator too influential is all it takes to topple a republic."),
                new TextObject("{=1Y8N3opd}- Every year, an election for ruler takes place (Republican succession){newline}- Settlement production quality +10%{newline}- Settlement loyalty +1{newline}- Settlement mercantilism +50%"),
                0.5f,
                -1f,
                0.6f,
                1f,
            ...
            Feudal.Initialize(new TextObject("{=3diNenit}Feudal"),
                new TextObject("{=O53wpX3c}Feudal governments stablish the authority of a life-serving ruler, while keeping a relatively degree of autonomy to their vassals. Unlike in empires, feudal societies have a strong sense of property, and legal claims and technicalities often take precedence over other factors. While the king or queen draw great influence, their subordinate peers are guaranteed certain securities that the ruler is bound by law to follow."),
                new TextObject("{=To6JFJDJ}- Petitioning rights yields no relation loss{newline}- Settlement stability +5%{newline}- Settlement prod. efficiency +10%{newline}- Settlement mercantilism +15%"),
                0.15f,
                -0.4f,
                0.7f,
                -0.2f,
