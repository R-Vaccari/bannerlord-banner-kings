...
namespace BannerKings.Managers.Goals.Decisions
{
    public class MakeCamp : Goal
    {
        ...
        {
            Initialize(new TextObject("{=!}Make Camp"),
        ...
        public override bool IsFulfilled(out List<TextObject> failedReasons)
        {
            ...
            {
                failedReasons.Add(new TextObject("{=!}Not party leader"));
            }
        ...
        {
            Hero fulfiller = GetFulfiller();
            InformationManager.ShowInquiry(new InquiryData(new TextObject("{=!}Make Camp").ToString(),
                new TextObject("{=!}Will you make camp in this position? Dismantling the camp will have the party disorganized for a couple hours.").ToString(),
                true,
                true,
