...
{
    public abstract class KingdomGoal : Goal
    {
        protected KingdomGoal(string stringId, Hero fulfiller = null) : base(stringId, fulfiller)
        {
        }
        ...
        public override void ShowInquiry()
        {
            ...
            (
                new InquiryData
                (
                    new TextObject("{=!}Establish a new Kingdom").ToString(),
