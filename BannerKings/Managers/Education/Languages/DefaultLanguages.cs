...
namespace BannerKings.Managers.Education.Languages
{
    public class DefaultLanguages : DefaultTypeInitializer<DefaultLanguages, Language>
    {
        ...
        public override void Initialize()
        {
            ...
            Vlandic.Initialize(new TextObject("{=V8rrAOxeo}Vlandic"), new TextObject(),
            ...
            Aseran.Initialize(new TextObject("{=KxXfB41uz}Aseran"), new TextObject(), cultures.First(x => x.StringId == "aserai"),
