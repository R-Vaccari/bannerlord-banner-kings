...
namespace BannerKings.Managers.Education.Languages
{
    public class DefaultLanguages : DefaultTypeInitializer<DefaultLanguages, Language>
    {
        ...
        public override void Initialize()
        {
            ...
            Vlandic.Initialize(new TextObject("{=mCWwRwsb}Vlandic"), new TextObject(),
            ...
            Aseran.Initialize(new TextObject("{=gqCJ3NHk}Aseran"), new TextObject(), cultures.First(x => x.StringId == "aserai"),
