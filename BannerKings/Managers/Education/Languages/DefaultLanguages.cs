...
namespace BannerKings.Managers.Education.Languages
{
    ...
    {
        public Language Battanian { get; } = new Language("language_battanian");
        public Language Vlandic { get; } = new Language("language_vlandic");
        public Language Calradian { get; } = new Language("language_calradian");
        public Language Sturgian { get; } = new Language("language_sturgian");
