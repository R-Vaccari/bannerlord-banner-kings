    ...
    public class DefaultBookTypes : DefaultTypeInitializer<DefaultBookTypes, BookType>
    {
        ...
        public override void Initialize()
        {
            ...
            HeatsDesire.Initialize(BKItems.Instance.BookHeartsDesire, 
                new TextObject("{=!}"), 
                DefaultLanguages.Instance.French, BookUse.Skillbook, DefaultSkills.Charm);

            Siege = new BookType("book_siege");
            Siege.Initialize(BKItems.Instance.BookSiege, 
                new TextObject("{=!}"), 
                DefaultLanguages.Instance.Sicilian, BookUse.Focusbook, DefaultSkills.Engineering);
            ...
            Strategikon.Initialize(BKItems.Instance.BookStrategikon, 
                ...
                DefaultLanguages.Instance.Sicilian, BookUse.Focusbook, DefaultSkills.Tactics);
            ...
            Trade.Initialize(BKItems.Instance.BookTrade, 
                ...
                DefaultLanguages.Instance.Arabic, BookUse.Focusbook, DefaultSkills.Trade);
            ...
            Dictionary.Initialize(BKItems.Instance.BookDictionary, 
                ...
                DefaultLanguages.Instance.Sicilian, 
                BookUse.Dictionary);

            Mounted = new BookType("book_riding");
            Mounted.Initialize(BKItems.Instance.BookMounted, 
                new TextObject("{=!}"), 
                DefaultLanguages.Instance.French, BookUse.Focusbook, DefaultSkills.Riding);

            Leadership = new BookType("book_leadership");
            Leadership.Initialize(BKItems.Instance.BookLeadership, 
                new TextObject("{=!}"), 
                DefaultLanguages.Instance.Sicilian, BookUse.Focusbook, DefaultSkills.Leadership);
            ...
            OneHanded.Initialize(BKItems.Instance.BookOneHanded, 
                ...
                DefaultLanguages.Instance.French, BookUse.Focusbook, DefaultSkills.OneHanded);
            ...
            TwoHanded.Initialize(BKItems.Instance.BookTwoHanded, 
                ...
                DefaultLanguages.Instance.AngloNorman, BookUse.Focusbook, DefaultSkills.TwoHanded);
            ...
            Crossbow.Initialize(BKItems.Instance.BookCrossbow, 
                ...
                DefaultLanguages.Instance.Sicilian, BookUse.Focusbook, DefaultSkills.Crossbow);
            ...
            (
                ...
                DefaultLanguages.Instance.Swedish,
                BookUse.Focusbook,
            ...
            (
                ...
                DefaultLanguages.Instance.Arabic,
                BookUse.Focusbook,
