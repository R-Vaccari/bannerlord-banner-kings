...
namespace BannerKings.Managers.Institutions.Religions.Faiths.Rites
{
    public class Offering : Rite
    {
        ...
        public override void Complete(Hero actionTaker)
        {
            ...
            MBInformationManager.AddQuickInformation(new TextObject("{=SvDKkEtdi}{OFFERING} was ritually offered by {HERO}.")
        ...
        public override void SetDialogue()
        {
            MBTextManager.SetTextVariable("CLERGYMAN_RITE_CONFIRM",
                new TextObject(
                        "{=Zc8JJ3QTJ}The fate of {HERO} was sealed once they dared draw sword on us. Affirm the rite and we shall rejoice upon the glory we bathe ourselves in as the enemy bleeds!")
