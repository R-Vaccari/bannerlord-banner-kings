...
namespace BannerKings.Managers.Institutions.Religions.Faiths.Rites
{
    public class Sacrifice : Rite
    {
        ...
        public override void Complete(Hero actionTaker)
        {
            ...
            MBInformationManager.AddQuickInformation(new TextObject("{=Xda3m4gWD}{SACRIFICE} was ritually sacrificed by {HERO}.")
        ...
        {
            return new TextObject("{=ubZgbozmq}Sacrifice {HERO} to prove your devotion.");
        }

        public override TextObject GetName()
        {
            return new TextObject("{=XT8rsXK89}Human Sacrifice");
        }
        ...
        {
            //MBTextManager.SetTextVariable("CLERGYMAN_RITE_CONFIRM", new TextObject("{=CLnqotS3n}The fate of {HERO} was sealed once they dared draw sword on us. Let us rejoice upon the glory we bathe ourselves in as the enemy bleeds!")
            //   .SetTextVariable("HERO", input.Name), false);
            MBTextManager.SetTextVariable("CLERGYMAN_RITE_CONFIRM",
                new TextObject(
                        "{=Fc0tMXQ6G}The fate of {HERO} was sealed once they dared draw sword on us. Affirm the rite and we shall rejoice upon the glory we bathe ourselves in as the enemy bleeds!")
