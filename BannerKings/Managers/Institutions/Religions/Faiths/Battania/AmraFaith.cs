...
namespace BannerKings.Managers.Institutions.Religions.Faiths.Battania
{
    public class AmraFaith : PolytheisticFaith
    {
        ...
        public override TextObject GetClergyForbiddenAnswer(int rank)
        {
            ...
            {
                text = new TextObject(
                    "{=8s8CQnhD}No respect shall ever come to those who bend the knee willingly, and least of all to the foreign upstarts who gnaw upon our holdings. Those who strike upon our wildling sons, wolfskin or otherwise, put our future in danger as a people.");
            }
            else
            {
                text = new TextObject(
                    "{=uUovu9Ds}Were you to lick the boot of Vlandian, Sturgian or make yourself a lackey to the Empire, I’d see you personally whipped raw and thrown into the salted waters of the Bay of Varcheg! If you strike down the wildlings and the wolfskins you run the risk of butchering the blooded leaders of Battania’s next generation - so sharpen your teeth against them as you are wont, but take not their heads.");
            }
        ...
        public override TextObject GetClergyGreetingInducted(int rank)
        {
            ...
            {
                text = new TextObject(
                    "{=MaOtbHO6}Croseo, kinsfolk. How does this season upon the Uchalion greet ye? Have you drunk of the Llyn Tywal lately? Bloodied the noses of Vlandian dogsbodies and Sturgian wastrels? You stand here upon our blessed soil and have fool’s pride enough to come upon your Brithem brethren and act his equal - so I must assume you make your ancestors proud or you’ve stones enough to stand in my eyeline and bluff!");
            }
            else
            {
                text = new TextObject(
                    "{=Pr6kjUr7}Croseo, you child of the Uchalion. Have you looked upon the Morcomb in recent days? Have you glutted yourself on the fish of the River Fiur? Bashed the teeth in of any southern fool who’d claim themselves emperor of all they survey? You stand before me on blessed soil and you speak to the Bandrui as though you were a Brithem or mormaer lordling - so I assume you’ve cause to bid for my counsel. Lest ye be a fool, though to be a fool can be a blessed thing.Fool’s have the chance to leave their foolishness behind, after all.");
            }
        ...
        public override TextObject GetClergyInduction(int rank)
        {
            ...
            else
            {
                ...
                {
                    text = new TextObject(
                        "{=jQPri20q}You’re a lout, a fool and were it not for the laws of hospitality which I choose to honor I’d bash your teeth in with a rock. You want to be inducted as a follower of the Amra Ollamh, best find yourself a Brithem who can tell you to sod off as I’ve only words to share so disparaging they’d rouse your grandmother from her grave and see her slap sense into that thick head of yours. Bah!");
                }
                else
                {
                    if (Hero.MainHero.GetSkillValue(DefaultSkills.Roguery) > 100)
        ...
        public override TextObject GetClergyInductionLast(int rank)
        {
            ...
            if (rank == 2)
            {
                ...
                {
                    text = new TextObject(
                        "{=52FGfd5h}Get out of my sight until you’ve got stones enough to be worthy of it. I’d excuse this if you were a child or at least born of the highlands; but you’re just wasting my time with that slackened look about your face!");
                }
                else
                {
                    if (Hero.MainHero.GetSkillValue(DefaultSkills.Roguery) > 100)
        ...
        {
            return new TextObject(
                "{=tPAZEBKs}And what spirits would ye be bound to? Those of wolves and warriors whose savagery are unmatched, or the spirits of Uchalion, who breathe fire into our hearts to fight the enemy?");
        }
