...
namespace BannerKings.Managers.Institutions.Religions.Faiths.Battania
{
    public class AmraFaith : PolytheisticFaith
    {
        ...
        public override TextObject GetClergyForbiddenAnswer(int rank)
        {
            ...
            {
                text = new TextObject(
                    "{=y0QhQGRaT}No respect shall ever come to those who bend the knee willingly, and least of all to the foreign upstarts who gnaw upon our holdings. Those who strike upon our wildling sons, wolfskin or otherwise, put our future in danger as a people.");
            }
            else
            {
                text = new TextObject(
                    "{=9m44c66Zu}Were you to lick the boot of Vlandian, Sturgian or make yourself a lackey to the Empire, I’d see you personally whipped raw and thrown into the salted waters of the Bay of Varcheg! If you strike down the wildlings and the wolfskins you run the risk of butchering the blooded leaders of Battania’s next generation - so sharpen your teeth against them as you are wont, but take not their heads.");
            }
        ...
        {
            var possible = true;
            var text = new TextObject("{=yFQ5Jk5wq}You will be converted");
            if (hero.GetSkillValue(DefaultSkills.Roguery) < 50)
            {
                possible = false;
                text = new TextObject("{=Q0CpTseyO}Not enough roquery");
            }

            if (hero.Culture != Utils.Helpers.GetCulture("battania"))
            {
                possible = false;
                text = new TextObject("{=NORLoXoU6}Unaccepted culture");
            }
        ...
        public override TextObject GetClergyGreetingInducted(int rank)
        {
            ...
            {
                text = new TextObject(
                    "{=LXog313Vr}Croseo, kinsfolk. How does this season upon the Uchalion greet ye? Have you drunk of the Llyn Tywal lately? Bloodied the noses of Vlandian dogsbodies and Sturgian wastrels? You stand here upon our blessed soil and have fool’s pride enough to come upon your Brithem brethren and act his equal - so I must assume you make your ancestors proud or you’ve stones enough to stand in my eyeline and bluff!");
            }
            else
            {
                text = new TextObject(
                    "{=c8Atr6Vpb}Croseo, you child of the Uchalion. Have you looked upon the Morcomb in recent days? Have you glutted yourself on the fish of the River Fiur? Bashed the teeth in of any southern fool who’d claim themselves emperor of all they survey? You stand before me on blessed soil and you speak to the Bandrui as though you were a Brithem or mormaer lordling - so I assume you’ve cause to bid for my counsel. Lest ye be a fool, though to be a fool can be a blessed thing.Fool’s have the chance to leave their foolishness behind, after all.");
            }
        ...
        public override TextObject GetClergyInduction(int rank)
        {
            ...
            else
            {
                ...
                {
                    text = new TextObject(
                        "{=VjMQzL2zM}You’re a lout, a fool and were it not for the laws of hospitality which I choose to honor I’d bash your teeth in with a rock. You want to be inducted as a follower of the Amra Ollamh, best find yourself a Brithem who can tell you to sod off as I’ve only words to share so disparaging they’d rouse your grandmother from her grave and see her slap sense into that thick head of yours. Bah!");
                }
                else
                {
                    if (Hero.MainHero.GetSkillValue(DefaultSkills.Roguery) > 100)
        ...
        public override TextObject GetClergyInductionLast(int rank)
        {
            ...
            if (rank == 2)
            {
                ...
                {
                    text = new TextObject(
                        "{=JC4zYsqay}Get out of my sight until you’ve got stones enough to be worthy of it. I’d excuse this if you were a child or at least born of the highlands; but you’re just wasting my time with that slackened look about your face!");
                }
                else
                {
                    if (Hero.MainHero.GetSkillValue(DefaultSkills.Roguery) > 100)
        ...
        {
            return new TextObject("{=PseD66LJu}Great Spirits");
        }
        ...
        public override TextObject GetRankTitle(int rank)
        {
            ...
            if (rank == 2)
            {
                text = new TextObject("{=y3CBQ47R0}Brithem");
            }
            else
            {
                text = new TextObject("{=8LDqjWP7V}Bandrui");
            }
        ...
        {
            return new TextObject("{=h5Jx7TtYN}Spirits");
        }

        public override TextObject GetBlessingAction()
        {
            return new TextObject("{=JeFEZncvs}I would like to swear an oath to the spirits.");
        }

        public override TextObject GetBlessingQuestion()
        {
            return new TextObject(
                "{=qjCugXBeF}And what spirits would ye be bound to? Those of wolves and warriors whose savagery are unmatched, or the spirits of Uchalion, who breathe fire into our hearts to fight the enemy?");
        }

        public override TextObject GetBlessingConfirmQuestion()
        {
            return new TextObject("{=gywYa6hOT}Be ye sure of that. Only a fool would break an oath with the spirits.");
        }

        public override TextObject GetBlessingQuickInformation()
        {
            return new TextObject("{=m82iYWOo3}{HERO} has sworn an oath to the {DIVINITY} spirits.");
        }

        public override TextObject GetBlessingActionName()
        {
            return new TextObject("{=M6n7zx1Er}pledge an oath to.");
        }
    }
}