...
namespace BannerKings.Managers.Institutions.Religions.Faiths.Battania
{
    public class AmraFaith : PolytheisticFaith
    {
        ...
        public override TextObject GetClergyForbiddenAnswer(int rank)
        {
            ...
            {
                text = new TextObject(
                    "{=6j80vg1ar}No respect shall ever come to those who bend the knee willingly, and least of all to the foreign upstarts who gnaw upon our holdings. Those who strike upon our wildling sons, wolfskin or otherwise, put our future in danger as a people.");
            }
            else
            {
                text = new TextObject(
                    "{=9JsArfHnD}Were you to lick the boot of Vlandian, Sturgian or make yourself a lackey to the Empire, I’d see you personally whipped raw and thrown into the salted waters of the Bay of Varcheg! If you strike down the wildlings and the wolfskins you run the risk of butchering the blooded leaders of Battania’s next generation - so sharpen your teeth against them as you are wont, but take not their heads.");
            }
        ...
        {
            var possible = true;
            var text = new TextObject("{=4PR0PBA1h}You will be converted");
            if (hero.GetSkillValue(DefaultSkills.Roguery) < 50)
            {
                possible = false;
                text = new TextObject("{=qqoEqOzHT}Not enough roquery");
            }

            if (hero.Culture != Utils.Helpers.GetCulture("battania"))
            {
                possible = false;
                text = new TextObject("{=41oH6m4sf}Unaccepted culture");
            }
        ...
        public override TextObject GetClergyGreetingInducted(int rank)
        {
            ...
            {
                text = new TextObject(
                    "{=6mDC80pFK}Croseo, kinsfolk. How does this season upon the Uchalion greet ye? Have you drunk of the Llyn Tywal lately? Bloodied the noses of Vlandian dogsbodies and Sturgian wastrels? You stand here upon our blessed soil and have fool’s pride enough to come upon your Brithem brethren and act his equal - so I must assume you make your ancestors proud or you’ve stones enough to stand in my eyeline and bluff!");
            }
            else
            {
                text = new TextObject(
                    "{=hXcpsHfqr}Croseo, you child of the Uchalion. Have you looked upon the Morcomb in recent days? Have you glutted yourself on the fish of the River Fiur? Bashed the teeth in of any southern fool who’d claim themselves emperor of all they survey? You stand before me on blessed soil and you speak to the Bandrui as though you were a Brithem or mormaer lordling - so I assume you’ve cause to bid for my counsel. Lest ye be a fool, though to be a fool can be a blessed thing.Fool’s have the chance to leave their foolishness behind, after all.");
            }
        ...
        public override TextObject GetClergyInduction(int rank)
        {
            ...
            else
            {
                ...
                {
                    text = new TextObject(
                        "{=iG0fdcecy}You’re a lout, a fool and were it not for the laws of hospitality which I choose to honor I’d bash your teeth in with a rock. You want to be inducted as a follower of the Amra Ollamh, best find yourself a Brithem who can tell you to sod off as I’ve only words to share so disparaging they’d rouse your grandmother from her grave and see her slap sense into that thick head of yours. Bah!");
                }
                else
                {
                    if (Hero.MainHero.GetSkillValue(DefaultSkills.Roguery) > 100)
        ...
        public override TextObject GetClergyInductionLast(int rank)
        {
            ...
            if (rank == 2)
            {
                ...
                {
                    text = new TextObject(
                        "{=kCSo7eBGv}Get out of my sight until you’ve got stones enough to be worthy of it. I’d excuse this if you were a child or at least born of the highlands; but you’re just wasting my time with that slackened look about your face!");
                }
                else
                {
                    if (Hero.MainHero.GetSkillValue(DefaultSkills.Roguery) > 100)
        ...
        {
            return new TextObject("{=wZsPbHwM3}Great Spirits");
        }
        ...
        public override TextObject GetRankTitle(int rank)
        {
            ...
            if (rank == 2)
            {
                text = new TextObject("{=tWacstfdi}Brithem");
            }
            else
            {
                text = new TextObject("{=g9GK1NTiT}Bandrui");
            }
        ...
        {
            return new TextObject("{=NBrsSH4MM}Spirits");
        }

        public override TextObject GetBlessingAction()
        {
            return new TextObject("{=cdfNcpurA}I would like to swear an oath to the spirits.");
        }

        public override TextObject GetBlessingQuestion()
        {
            return new TextObject(
                "{=k8HFuQY6Q}And what spirits would ye be bound to? Those of wolves and warriors whose savagery are unmatched, or the spirits of Uchalion, who breathe fire into our hearts to fight the enemy?");
        }

        public override TextObject GetBlessingConfirmQuestion()
        {
            return new TextObject("{=0E9JvchUU}Be ye sure of that. Only a fool would break an oath with the spirits.");
        }

        public override TextObject GetBlessingQuickInformation()
        {
            return new TextObject("{=jLyE71Wfo}{HERO} has sworn an oath to the {DIVINITY} spirits.");
        }

        public override TextObject GetBlessingActionName()
        {
            return new TextObject("{=W6x8TQ5mM}pledge an oath to.");
        }
    }
}