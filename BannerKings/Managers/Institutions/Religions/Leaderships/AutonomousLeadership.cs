...
namespace BannerKings.Managers.Institutions.Religions.Leaderships
{
    public class AutonomousLeadership : DescentralizedLeadership
    {
        ...
        {
            return new TextObject("{=UosVkyO5}Autonomous religions do not have any sort of hierarchy for their spiritual guides. Even though different kinds of clergymen can exist, they are equally considered a 'head of faith' on their own right.");
        }
