...
namespace BannerKings.Managers.Institutions.Religions
{
    public class DefaultDivinities
    {
        ...
        {
            AseraMain = new Divinity("asera-main", new TextObject("{=YSb8kPWJA}Asera the Patriarch"),
                new TextObject(
                    "{=vCyNociD5}First of his line, the legendary patriarch united the various badw tribes of the Nahasa and the coastal Behr al-Yeshm into the lawful confederacy of the Aserai Sultanate. Asera was deified by his deeds and the codes of law which allowed him to establish dominion and settle his people from the Jabal Tamar to the Jabal Ashab. Asera is that which all followers of his Code seek to live up to; though most followers will accept that the words of Asera are transcribed to benefit the bloodlines which followed him. Thus one can only ever seek to live as Asera did, and to know only their success upon arrival in Paradise."),
                new TextObject());

            AseraSecondary1 = new Divinity("asera-secondary-1", new TextObject("{=aGTZJpDFZ}Damma-Siddiq"),
                new TextObject(
                    "{=EzB8ZOjHO}Descended from those who dedicated themselves to the Code of Asera but who were married into the true bloodlines of Asera’s descendents are known as the Damma-Siddiq; those of truthful blood. It is through their reforms, compromises, and bold rhetoric that marriage may allow even those born outside the Sultanate to come to be viewed as being of the blood of Asera - albeit through legalism and spirit."),
                new TextObject(),
                new TextObject("{=Sioiha4RB}School"));

            AseraSecondary2 = new Divinity("asera-secondary-2", new TextObject("{=3OuYuF7xq}Ibn-Zakaa"),
                new TextObject(
