...
namespace BannerKings.Managers.Skills
{
    public class BKPerks : DefaultTypeInitializer<BKPerks, PerkObject>
    {
        ...
        public override void Initialize()
        {
            ...
            TheologyFaithful.InitializeNew("{=Fhvvi9dfu}Traditionalist", BKSkills.Instance.Lordship, GetTierCost(1),
                LordshipAdaptive,
            ...
            TheologyBlessed.InitializeNew("{=Fhvvi9dfu}Traditionalist", BKSkills.Instance.Lordship, GetTierCost(2),
                LordshipAdaptive,
            ...
            TheologyReligiousTeachings.InitializeNew("{=Fhvvi9dfu}Traditionalist", BKSkills.Instance.Lordship, GetTierCost(3),
                LordshipAdaptive,
            ...
            TheologyPreacher.InitializeNew("{=dphuJfBDM}Preacher", BKSkills.Instance.Lordship, GetTierCost(4),
                ...
                SkillEffect.PerkRole.Personal, 0.2f,
                SkillEffect.EffectIncrementType.Add,
                "{=e00wU5Qey}Settlement conversion speed increased by X%.",
                SkillEffect.PerkRole.Ruler, 1f,
                SkillEffect.EffectIncrementType.Add);
            ...
            TheologyLithurgy.InitializeNew("{=dphuJfBDM}Preacher", BKSkills.Instance.Lordship, GetTierCost(5),
                LordshipAdaptive,
                "{=bS5cKw0Ro}Randomly receive relations with religious notables in your settlements.",
                SkillEffect.PerkRole.Personal, 0.2f,
                SkillEffect.EffectIncrementType.Add,
