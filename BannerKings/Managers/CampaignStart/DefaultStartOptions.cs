    ...
    public class DefaultStartOptions : DefaultTypeInitializer<DefaultStartOptions, StartOption>
    {
        ...
        public override void Initialize()
        {
            ...
            IndebtedLord.Initialize(new TextObject("{=2VoYzCNj}Indebted Lord"),
                ...
                new TextObject("{=!}Start as a lord in a kingdom, with a Lordship title. Redcued influence for 5 years. The village you own can be managed by you. Gain Scholarship skill."),
                0, 25, 10, 50, -50f,
                () =>
                {
