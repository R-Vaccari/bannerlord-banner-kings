...
namespace BannerKings.Managers.Kingdoms
{
    public class RepublicElectionDecision : BKKingElectionDecision
    {
        ...
        {
            var textObject = new TextObject("{=!}Choose the next Grand-Prince of the {KINGDOM_NAME} Republic");
        ...
        public override TextObject GetSupportDescription()
        {
            var textObject =
                new TextObject(
                    "{=!}{KINGDOM_NAME} Republic will decide who will be elected Grand-Prince. You can pick your stance regarding this decision.");
            textObject.SetTextVariable("KINGDOM_NAME", Kingdom.Name);
            return textObject;
        }
