    ...
    public class DefaultKingdomPolicies
    {
        ...
        public void Init()
        {
            PrivilegedKnighthood.Initialize(new TextObject("{=3UAFVNOE}Privileged Knighthood"),
                new TextObject(
                    "{=c9Cwm6Ek}Knights of cultures different to the kingdom's culture will no longer be accepted. Knights with demesne of kingdom culture will recieve a special tithe, helping them sustein their retinues."),
