...
namespace BannerKings.Managers.Kingdoms.Policies
{
    public class BKPolicies : DefaultTypeInitializer<BKPolicies, PolicyObject>
    {
        ...
        public override void Initialize()
        {
            ...
            LimitedArmyPrivilege.Initialize(new TextObject("{=jb9007ttU}Limited Army Privilege"),
                new TextObject(
                    "{=HhnsmYnQ3}The privilege of raising armies will be limited to lords of duke level or superior, as well as the crown Marshal."),
                new TextObject("{=NUcmTaexr}limiting the privilege to raise armies"),
                new TextObject(
                    "{=OWK9uVFt0}Only crown Marhsal or lords with Duke title or higher may create armies\nArmy influence costs increased by 30%\nArmy members receive 50% more influence"),
                0.7f, 0.15f, -0.7f);
        }
    }
}