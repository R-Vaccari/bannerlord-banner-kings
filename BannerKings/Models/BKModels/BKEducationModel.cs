...
namespace BannerKings.Models.BKModels
{
    public class BKEducationModel : IBannerKingsModel
    {
        ...
        public ExplainedNumber CalculateLanguageLearningRate(Hero student, Hero instructor, Language language)
        {
            ...
            {
                result.AddFactor(teaching, new TextObject("{=TPWiQZwNo}Instructor fluency"));
            }
            ...
            {
                result.Add(dic[language], new TextObject("{=G7gaboXCx}Intelligibility with {LANGUAGE}").SetTextVariable("LANGUAGE", native.Name));
            }
            ...
            if (overLimit > 0f)
            {
                result.AddFactor(-0.33f * overLimit, new TextObject("{=d5T70BX0x}Over languages limit"));
            }
        ...
        public ExplainedNumber CalculateBookReadingRate(BookType book, Hero reader)
        {
            ...
            result.Add(fluency, new TextObject("{=3jrpJw9nr}{LANGUAGE} fluency").SetTextVariable("LANGUAGE", book.Language.Name));
