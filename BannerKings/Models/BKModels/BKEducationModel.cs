...
namespace BannerKings.Models.BKModels
{
    public class BKEducationModel : IBannerKingsModel
    {
        ...
        public ExplainedNumber CalculateLanguageLearningRate(Hero student, Hero instructor, Language language)
        {
            ...
            {
                result.AddFactor(teaching, new TextObject("{=CErqQgrX}Instructor fluency"));
            }
            ...
            {
                result.Add(dic[language], new TextObject("{=ZpYWPoKt}Intelligibility with {LANGUAGE}").SetTextVariable("LANGUAGE", native.Name));
            }
            ...
            if (overLimit > 0f)
            {
                result.AddFactor(-0.33f * overLimit, new TextObject("{=dy9RPm6L}Over languages limit"));
            }
        ...
        public ExplainedNumber CalculateBookReadingRate(BookType book, Hero reader)
        {
            ...
            result.Add(fluency, new TextObject("{=neN6L1tg}{LANGUAGE} fluency").SetTextVariable("LANGUAGE", book.Language.Name));
