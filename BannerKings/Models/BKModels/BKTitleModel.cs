...
namespace BannerKings.Models.BKModels
{
    public class BKTitleModel : IBannerKingsModel
    {
        ...
        public ExplainedNumber GetGrantKnighthoodCost(Hero grantor)
        {
            ...
            if (extra != 0f)
            {
                result.Add(extra, new TextObject("{=y3phxnMsz}Highest title level"));
            }
        ...
        public TitleAction GetFoundKingdom(Kingdom faction, Hero founder)
        {
            ...
            if (faction == null)
            {
                ...
                foundAction.Reason = new TextObject("{=7T8JvgLmB}No kingdom.");
                return foundAction;
            }
            ...
            {
                foundAction.Possible = false;
                foundAction.Reason = new TextObject("{=br2JYsRGF}Faction sovereign title already exists.");
                return foundAction;
            }
            ...
            {
                foundAction.Possible = false;
                foundAction.Reason = new TextObject("{=7yOeujNtu}Not leader of current faction.");
                return foundAction;
            }
            ...
            {
                foundAction.Possible = false;
                foundAction.Reason = new TextObject("{=GYivKhyTx}Cannot found a kingdom while already being a de Jure sovereign.");
                return foundAction;
            }
            ...
            {
                foundAction.Possible = false;
                foundAction.Reason = new TextObject("{=1TpNE9nWD}Cannot found a kingdom without a de Jure duke level title.");
                return foundAction;
            }
            ...
            {
                foundAction.Possible = false;
                foundAction.Reason = new TextObject("{=DWOxXmSCx}Cannot found a kingdom for a faction with less than 3 clans.");
                return foundAction;
            }
            ...
            {
                foundAction.Possible = false;
                foundAction.Reason = new TextObject("{=AWrPkvv6f}You lack the required resources.");
                return foundAction;
            }

            foundAction.Possible = true;
            foundAction.Reason = new TextObject("{=b0ycRjKb0}Kingdom can be founded.");
        ...
        private TitleAction GetClaim(FeudalTitle title, Hero claimant)
        {
            ...
            if (title.deJure == claimant)
            {
                ...
                claimAction.Reason = new TextObject("{=oEu1DsDgX}Already legal owner.");
                return claimAction;
            }
            ...
            {
                claimAction.Possible = false;
                claimAction.Reason = new TextObject("{=TidWejB7P}Not a possible claimant.");
                return claimAction;
            }
            ...
            {
                claimAction.Possible = false;
                claimAction.Reason = new TextObject("{=pNv5Vp3vh}Already building a claim.");
                return claimAction;
            }
            ...
            {
                claimAction.Possible = false;
                claimAction.Reason = new TextObject("{=kQ3mX3ApD}Already a claimant.");
                return claimAction;
            }
            ...
            {
                claimAction.Possible = false;
                claimAction.Reason = new TextObject("{=HmStM2dAj}Owner is in same clan.");
                return claimAction;
            }
            ...
            if (title.type == TitleType.Lordship)
            {
                    ...
                    BannerKingsConfig.Instance.TitleManager.GetAllDeJure(title.deJure).Count == 1)
                {
                    claimAction.Possible = false;
                    claimAction.Reason =
                        new TextObject("{=6oF8RhQCc}Not possible to claim a knight's lordship within your faction.");
                    return claimAction;
                }
                ...
                if (claimant != boundTitle.deJure)
                {
                    claimAction.Possible = false;
                    claimAction.Reason =
                        new TextObject("{=3AgKWRvr7}Not possible to claim lordships without owning it's suzerain title.");
                    return claimAction;
                }
            }
            ...
            {
                claimAction.Possible = false;
                claimAction.Reason = new TextObject("{=5V5iQhvhZ}Missing required resources.");
                return claimAction;
            }

            claimAction.Possible = true;
            claimAction.Reason = new TextObject("{=tLLsn5zmk}You may claim this title.");
        ...
        private TitleAction GetRevoke(FeudalTitle title, Hero revoker)
        {
            ...
            if (title.deJure == revoker)
            {
                ...
                revokeAction.Reason = new TextObject("{=oEu1DsDgX}Already legal owner.");
                return revokeAction;
            }
            ...
            {
                revokeAction.Possible = false;
                revokeAction.Reason = new TextObject("{=z7zz53FKg}Can not revoke a title of a lord outside your realm.");
                return revokeAction;
            }
            ...
            switch (governmentType)
            {
                case GovernmentType.Tribal:
                    revokeAction.Possible = false;
                    revokeAction.Reason = new TextObject("{=QLfMUVTsC}Tribal government does not allow revoking.");
                    return revokeAction;
                case GovernmentType.Republic when title.type != TitleType.Dukedom:
                    revokeAction.Possible = false;
                    revokeAction.Reason = new TextObject("{=6T1RECJZK}Republics can only revoke duke titles.");
                    return revokeAction;
                case GovernmentType.Republic:
                {
                    ...
                    {
                        revokeAction.Possible = false;
                        revokeAction.Reason = new TextObject("{=uALtBXyMb}Not de Jure faction leader.");
                        return revokeAction;
                    }
                ...
                default:
                {
                    ...
                    {
                        revokeAction.Possible = false;
                        revokeAction.Reason = new TextObject("{=Uea8M8J8i}Not a direct vassal.");
                        return revokeAction;
                    }
            ...
            {
                revokeAction.Possible = false;
                revokeAction.Reason = new TextObject("{=hJExfjwKZ}Can not revoke from a lord of superior hierarchy.");
                return revokeAction;
            }

            revokeAction.Possible = true;
            revokeAction.Reason = new TextObject("{=rBDoZXFNu}You may grant away this title.");
        ...
        private TitleAction GetGrant(FeudalTitle title, Hero grantor)
        {
            ...
            if (title.deJure != grantor)
            {
                ...
                grantAction.Reason = new TextObject("{=9JTUtJRtr}Not legal owner.");
                return grantAction;
            }
            ...
            if (title.fief != null)
            {
                ...
                {
                    grantAction.Possible = false;
                    grantAction.Reason = new TextObject("{=jfweigade}Not actual owner of landed title.");
                    return grantAction;
                }
            }
            ...
            if (title.type > TitleType.Lordship)
            {
                ...
                {
                    grantAction.Possible = false;
                    grantAction.Reason = new TextObject("{=jaQVGNjhQ}No valid candidates in kingdom.");
                    return grantAction;
                }
            }
            ...
            {
                grantAction.Possible = false;
                grantAction.Reason = new TextObject("{=hopVOCgiP}Not possible to grant one's main title.");
                return grantAction;
            }

            grantAction.Possible = true;
            grantAction.Influence = GetInfluenceUsurpCost(title) * 0.33f;
            grantAction.Reason = new TextObject("{=rBDoZXFNu}You may grant away this title.");
        ...
        public TitleAction GetUsurp(FeudalTitle title, Hero usurper)
        {
            ...
            if (title.deJure == usurper)
            {
                ...
                usurpData.Reason = new TextObject("{=oEu1DsDgX}Already legal owner.");
                return usurpData;
            }
            ...
            {
                usurpData.Possible = false;
                usurpData.Reason = new TextObject("{=Bd8Qv70Fj}No clan.");
                return usurpData;
            }
            ...
            if (type != ClaimType.None && type != ClaimType.Ongoing)
            {
                ...
                usurpData.Reason = new TextObject("{=tLLsn5zmk}You may claim this title.");
                ...
                {
                    usurpData.Possible = false;
                    usurpData.Reason = new TextObject("{=htDYn09yw}Clan tier is insufficient.");
                    return usurpData;
                }
                ...
                {
                    usurpData.Possible = false;
                    usurpData.Reason = new TextObject("{=5V5iQhvhZ}Missing required resources.");
                    return usurpData;
                }
                ...
                if (title.IsSovereignLevel)
                {
                    ...
                    if (faction.Leader != usurper)
                    {
                        usurpData.Possible = false;
                        usurpData.Reason =
                            new TextObject("{=KKE5n1Dcu}Must be faction leader to usurp highest title in hierarchy.");
                        return usurpData;
                    }
                }
            ...
            usurpData.Possible = false;
            usurpData.Reason = new TextObject("{=is6Ynhi9d}No rightful claim.");
