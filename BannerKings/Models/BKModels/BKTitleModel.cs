...
namespace BannerKings.Models.BKModels
{
    public class BKTitleModel : IBannerKingsModel
    {
        ...
        public ExplainedNumber GetGrantKnighthoodCost(Hero grantor)
        {
            ...
            if (extra != 0f)
            {
                result.Add(extra, new TextObject("{=Pxao29dYo}Highest title level"));
            }
        ...
        public TitleAction GetFoundKingdom(Kingdom faction, Hero founder)
        {
            ...
            if (faction == null)
            {
                ...
                foundAction.Reason = new TextObject("{=rP9jSi59v}No kingdom.");
                return foundAction;
            }
            ...
            {
                foundAction.Possible = false;
                foundAction.Reason = new TextObject("{=g6yCpbfnD}Faction sovereign title already exists.");
                return foundAction;
            }
            ...
            {
                foundAction.Possible = false;
                foundAction.Reason = new TextObject("{=Jm1uPLYtS}Not leader of current faction.");
                return foundAction;
            }
            ...
            {
                foundAction.Possible = false;
                foundAction.Reason = new TextObject("{=Tp9kGFWkg}Cannot found a kingdom while already being a de Jure sovereign.");
                return foundAction;
            }
            ...
            {
                foundAction.Possible = false;
                foundAction.Reason = new TextObject("{=Bf05QBw0N}Cannot found a kingdom without a de Jure duke level title.");
                return foundAction;
            }
            ...
            {
                foundAction.Possible = false;
                foundAction.Reason = new TextObject("{=sbKzF5ZSv}Cannot found a kingdom for a faction with less than 3 clans.");
                return foundAction;
            }
            ...
            {
                foundAction.Possible = false;
                foundAction.Reason = new TextObject("{=mvEBjB2Ua}You lack the required resources.");
                return foundAction;
            }

            foundAction.Possible = true;
            foundAction.Reason = new TextObject("{=PZNyzu0DG}Kingdom can be founded.");
        ...
        private TitleAction GetClaim(FeudalTitle title, Hero claimant)
        {
            ...
            if (title.deJure == claimant)
            {
                ...
                claimAction.Reason = new TextObject("{=rM0nSMUbo}Already legal owner.");
                return claimAction;
            }
            ...
            {
                claimAction.Possible = false;
                claimAction.Reason = new TextObject("{=Sz011HM1H}Not a possible claimant.");
                return claimAction;
            }
            ...
            {
                claimAction.Possible = false;
                claimAction.Reason = new TextObject("{=j2O0eJvNB}Already building a claim.");
                return claimAction;
            }
            ...
            {
                claimAction.Possible = false;
                claimAction.Reason = new TextObject("{=9kwNF5Z32}Already a claimant.");
                return claimAction;
            }
            ...
            {
                claimAction.Possible = false;
                claimAction.Reason = new TextObject("{=M8F49nPwx}Owner is in same clan.");
                return claimAction;
            }
            ...
            if (title.type == TitleType.Lordship)
            {
                    ...
                    BannerKingsConfig.Instance.TitleManager.GetAllDeJure(title.deJure).Count == 1)
                {
                    claimAction.Possible = false;
                    claimAction.Reason =
                        new TextObject("{=PY2O79Vrn}Not possible to claim a knight's lordship within your faction.");
                    return claimAction;
                }
                ...
                if (claimant != boundTitle.deJure)
                {
                    claimAction.Possible = false;
                    claimAction.Reason =
                        new TextObject("{=hSQrJShtW}Not possible to claim lordships without owning it's suzerain title.");
                    return claimAction;
                }
            }
            ...
            {
                claimAction.Possible = false;
                claimAction.Reason = new TextObject("{=nYQMEDg9g}Missing required resources.");
                return claimAction;
            }

            claimAction.Possible = true;
            claimAction.Reason = new TextObject("{=3EORaNufv}You may claim this title.");
        ...
        private TitleAction GetRevoke(FeudalTitle title, Hero revoker)
        {
            ...
            if (title.deJure == revoker)
            {
                ...
                revokeAction.Reason = new TextObject("{=rM0nSMUbo}Already legal owner.");
                return revokeAction;
            }
            ...
            {
                revokeAction.Possible = false;
                revokeAction.Reason = new TextObject("{=ZKkvPWi9z}Can not revoke a title of a lord outside your realm.");
                return revokeAction;
            }
            ...
            switch (governmentType)
            {
                case GovernmentType.Tribal:
                    revokeAction.Possible = false;
                    revokeAction.Reason = new TextObject("{=Khu4XJSUo}Tribal government does not allow revoking.");
                    return revokeAction;
                case GovernmentType.Republic when title.type != TitleType.Dukedom:
                    revokeAction.Possible = false;
                    revokeAction.Reason = new TextObject("{=2yjSihcsg}Republics can only revoke duke titles.");
                    return revokeAction;
                case GovernmentType.Republic:
                {
                    ...
                    {
                        revokeAction.Possible = false;
                        revokeAction.Reason = new TextObject("{=eGJaJqttf}Not de Jure faction leader.");
                        return revokeAction;
                    }
                ...
                default:
                {
                    ...
                    {
                        revokeAction.Possible = false;
                        revokeAction.Reason = new TextObject("{=BcJLnN1Y8}Not a direct vassal.");
                        return revokeAction;
                    }
            ...
            {
                revokeAction.Possible = false;
                revokeAction.Reason = new TextObject("{=RgcdSiNK4}Can not revoke from a lord of superior hierarchy.");
                return revokeAction;
            }

            revokeAction.Possible = true;
            revokeAction.Reason = new TextObject("{=CSLNSyZNV}You may grant away this title.");
        ...
        private TitleAction GetGrant(FeudalTitle title, Hero grantor)
        {
            ...
            if (title.deJure != grantor)
            {
                ...
                grantAction.Reason = new TextObject("{=3RJP23wDx}Not legal owner.");
                return grantAction;
            }
            ...
            if (title.fief != null)
            {
                ...
                {
                    grantAction.Possible = false;
                    grantAction.Reason = new TextObject("{=mmEraNEjM}Not actual owner of landed title.");
                    return grantAction;
                }
            }
            ...
            if (title.type > TitleType.Lordship)
            {
                ...
                {
                    grantAction.Possible = false;
                    grantAction.Reason = new TextObject("{=8QfRXeEek}No valid candidates in kingdom.");
                    return grantAction;
                }
            }
            ...
            {
                grantAction.Possible = false;
                grantAction.Reason = new TextObject("{=g5fg6Qd5r}Not possible to grant one's main title.");
                return grantAction;
            }

            grantAction.Possible = true;
            grantAction.Influence = GetInfluenceUsurpCost(title) * 0.33f;
            grantAction.Reason = new TextObject("{=CSLNSyZNV}You may grant away this title.");
        ...
        public TitleAction GetUsurp(FeudalTitle title, Hero usurper)
        {
            ...
            if (title.deJure == usurper)
            {
                ...
                usurpData.Reason = new TextObject("{=rM0nSMUbo}Already legal owner.");
                return usurpData;
            }
            ...
            {
                usurpData.Possible = false;
                usurpData.Reason = new TextObject("{=eU7Hf0zKP}No clan.");
                return usurpData;
            }
            ...
            if (type != ClaimType.None && type != ClaimType.Ongoing)
            {
                ...
                usurpData.Reason = new TextObject("{=3EORaNufv}You may claim this title.");
                ...
                {
                    usurpData.Possible = false;
                    usurpData.Reason = new TextObject("{=Pohr0vtQq}Clan tier is insufficient.");
                    return usurpData;
                }
                ...
                {
                    usurpData.Possible = false;
                    usurpData.Reason = new TextObject("{=nYQMEDg9g}Missing required resources.");
                    return usurpData;
                }
                ...
                if (title.IsSovereignLevel)
                {
                    ...
                    if (faction.Leader != usurper)
                    {
                        usurpData.Possible = false;
                        usurpData.Reason =
                            new TextObject("{=mMmZV5QY6}Must be faction leader to usurp highest title in hierarchy.");
                        return usurpData;
                    }
                }
            ...
            usurpData.Possible = false;
            usurpData.Reason = new TextObject("{=i9NBsmuSd}No rightful claim.");
