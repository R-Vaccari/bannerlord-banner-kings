...
namespace BannerKings.Models.Vanilla
{
    public class BKEconomyModel : DefaultSettlementEconomyModel, IEconomyModel
    {
        ...
        public ExplainedNumber CalculateEffect(Settlement settlement)
        {
            ...
            {
                result.Add(0.1f, new TextObject("{=ehpHafrzC}Encourage mercantilism decision"));
            }
        ...
        public ExplainedNumber CalculateProductionEfficiency(Settlement settlement)
        {
            ...
            {
                result.AddFactor(0.15f, new TextObject("{=JdxsptigJ}Government"));
            }
        ...
        public ExplainedNumber CalculateProductionQuality(Settlement settlement)
        {
            ...
            result.Add((CalculateEffect(settlement).ResultNumber - 0.4f) * 0.5f, new TextObject("{=waPRPOLtg}Mercantilism"));
        ...
        public ExplainedNumber GetCaravanPrice(Settlement settlement, Hero buyer, bool isLarge = false)
        {
            ...
            {
                var data = BannerKingsConfig.Instance.PopulationManager.GetPopData(settlement);
                cost.AddFactor(1f - data.EconomicData.Mercantilism.ResultNumber, new TextObject("{=v9nRuwEdR}Mecantilism"));
                cost.AddFactor(data.EconomicData.CaravanAttraction.ResultNumber - 1f,
                    new TextObject("{=rXdmZzGyj}Caravan attraction"));
            }
        ...
        public ExplainedNumber CalculateCaravanAttraction(Settlement settlement)
        {
            ...
            var data = BannerKingsConfig.Instance.PopulationManager.GetPopData(settlement);
            result.Add(data.EconomicData.Mercantilism.ResultNumber / 2f, new TextObject("{=waPRPOLtg}Mercantilism"));
            result.AddFactor(data.MilitaryData.Militarism.ResultNumber * -1f, new TextObject("{=LF5HLFPSD}Militarism"));
